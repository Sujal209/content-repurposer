...
const stats = [
  {
    ...
    description: "Content creators trust RepurposeMate",
  ...
  },
  {
    ...
    description: "Creators love RepurposeMate",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Join thousands of content creators who are scaling their reach with RepurposeMate
          </p>
        </motion.div>
