...
const creators = [
  {
    ...
    avatar: "AJ",
    story: "Went from 15K to 45K followers using ContentCraft to repurpose technical blog posts into engaging Twitter threads.",
    platform: "Twitter"
  },
  {
    name: "Maria Santos",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Real creators, real results. See how ContentCraft helped them scale their audience.
          </p>
        </motion.div>
