        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted max-w-2xl mx-auto mb-6">
              These terms govern your use of RepurposeMate's AI-powered content transformation service. Please read carefully before transforming your content.
            </p>
          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted">
                <p>By accessing or using RepurposeMate, you agree to be bound by these Terms of Service and our Privacy Policy. If you disagree with any part of these terms, you may not use our service.</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted">
                <p>RepurposeMate transforms your blog posts, articles, and long-form content into engaging social media posts using advanced AI. We support Twitter threads, LinkedIn carousels, and Instagram Reels with platform-specific optimization.</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted">
                <p>You retain complete ownership of all content you input into RepurposeMate. We claim no rights to your original content or generated transformations.</p>
                ...
                <p>RepurposeMate's AI algorithms, prompt engineering, and transformation technology are proprietary and protected by intellectual property laws.</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted">
                <p>RepurposeMate's AI transformations are provided "as is". We don't guarantee specific content quality, engagement rates, or transformation accuracy.</p>
