          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted">
                <p>By accessing or using ContentCraft, you agree to be bound by these Terms of Service and our Privacy Policy. If you disagree with any part of these terms, you may not use our service.</p>
