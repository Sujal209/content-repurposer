        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted max-w-2xl mx-auto mb-6">
              Learn how RepurposeMate uses cookies to enhance your AI content transformation experience and remember your preferences.
            </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-orange-700 text-sm mb-3">
                      If you disable cookies, some features of RepurposeMate may not work properly:
                    </p>
