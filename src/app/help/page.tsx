...
const faqData: FAQItem[] = [
  ...
  {
    id: '2',
    question: 'What types of content work best with ContentCraft?',
    answer: 'ContentCraft works excellently with blog posts, articles, newsletters, case studies, tutorials, and any long-form written content. The ideal length is between 500-10,000 characters for best transformation results.',
    category: 'Getting Started'
  },
  {
    id: '3',
  ...
  {
    id: '7',
    question: 'What languages does ContentCraft support?',
    answer: 'Currently, ContentCraft works best with English content. We\'re working on expanding language support and will announce new languages as they become available.',
    category: 'Features'
  },
  {
    id: '8',
...
const tutorials = [
  {
    ...
    description: 'Get up and running with ContentCraft in under 5 minutes',
    duration: '3 min read',
    icon: Zap,
    link: '#'
  },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted mb-8">
              Find answers to common questions and learn how to get the most out of ContentCraft
            </p>
          ...
          >
            ...
            <Card className="hover:shadow-lg transition-shadow cursor-pointer" onClick={() => window.location.href = '/community'}>
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Connect with other ContentCraft users
                </CardDescription>
              </CardHeader>
            </Card>
          </motion.div>
